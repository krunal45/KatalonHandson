...
companies= ["Sample Company 1","Sample Company 2","Sample Company 3"];
WebUI.openBrowser(webUrl)
WebUI.setText(findTestObject('Object Repository/Page_FreeCRM/Page_Cogmento CRM/input_Login_email'), userName)
...
WebUI.click(findTestObject('Object Repository/Page_FreeCRM/Page_Cogmento CRM/span_Companies'))
WebUI.click(findTestObject('Object Repository/Page_FreeCRM/Page_Cogmento CRM/button_Create'))
WebUI.setText(findTestObject('Object Repository/Page_FreeCRM/Page_Cogmento CRM/input_The field Name is required_name'),companies[i])
