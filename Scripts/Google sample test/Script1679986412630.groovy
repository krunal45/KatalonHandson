...
//
//if (pageTitle.equals('OrangeHRMghgd')) {
//	System.out.print('Page Title matches.')
//}else {System.out.print('Page Title misMatches.')}
...
switch(pageTitle) {
  ...
  default:
  System.out.print('Page Title Mismatch !')
  break;
}

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/p_Raghvendra chandel'))
